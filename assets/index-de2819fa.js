...
function Dc(e, n, t, r, l, o, u, i, s) {
  (Et = !1), (Rr = null), Oc.apply(Mc, arguments);
}
...
var Ss = ye.unstable_scheduleCallback,
  ...
  W = ye.unstable_now,
  $c = ye.unstable_getCurrentPriorityLevel,
...
function bo(e, n, t, r) {
  if (jr) {
    ...
    else if ((Yu(e, r), n & 4 && -1 < Xc.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jt(l);
        if (
          (o !== null && Ns(o),
...
var ot = {
  ...
  Zu = we(tl),
  ef = A({}, tl, { dataTransfer: 0 }),
  nf = we(ef),
  tf = A({}, Zt, { relatedTarget: 0 }),
  Pl = we(tf),
  rf = A({}, ot, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  lf = we(rf),
  of = A({}, ot, {
...
var pf = A({}, Zt, {
  ...
  yf = we(hf),
  gf = A({}, ot, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  wf = we(gf),
  kf = A({}, tl, {
    deltaX: function (e) {
...
var xf = We && "TextEvent" in window && !xt,
  Ms = We && (!ru || (xt && 8 < xt && 11 >= xt)),
...
for (var Rl = 0; Rl < ii.length; Rl++) {
  var Ol = ii[Rl],
    If = Ol.toLowerCase(),
    Ff = Ol[0].toUpperCase() + Ol.slice(1);
  pn(If, "on" + Ff);
}
...
var kt =
  ...
  Uf = new Set("cancel close invalid load scroll toggle".split(" ").concat(kt));
function si(e, n, t) {
  ...
  if (!e[cr]) {
    (e[cr] = !0),
      ns.forEach(function (t) {
        t !== "selectionchange" && (Uf.has(t) || Ml(t, !1, e), Ml(t, !0, e));
      });
...
var yo = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Bf =
    typeof queueMicrotask == "function"
      ...
      : typeof fi < "u"
      ? function (e) {
          return fi.resolve(null).then(e).catch(Hf);
        }
      : yo;
function Hf(e) {
  setTimeout(function () {
...
function vn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Ss(Zo, vn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function pu(e, n) {
  switch ((M(Bt, n), M(Vt, e), M(Ue, qt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function Sa(e, n, t) {
  return (Pn & 21) === 0
    ...
    : (Me(t, n) || ((t = Cs()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
      n);
}
function Gf(e, n) {
  var t = O;
...
function Li(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Nr(e, n), ra(n, t, r), Co(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
function sd(e, n) {
  ...
  for (vo = { focusedElem: e, selectionRange: t }, jr = !1, S = n; S !== null; )
...
function Fa(e) {
  ...
  n !== null && ((e.alternate = null), Fa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[go], delete n[Wf], delete n[Qf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Ku(t), n === 1))
      e.tag === 0 ? Kf(Ui.bind(null, e)) : Zs(Ui.bind(null, e)),
        Bf(function () {
          (R & 6) === 0 && vn();
        }),
        (t = null);
...
function Ba(e, n) {
  ...
  if ((r & 30) !== 0 || (r & e.expiredLanes) !== 0 || n) n = qr(e, r);
    ...
    R |= 2;
    var o = Wa();
    (Z !== e || q !== n) && (($e = null), (rt = W() + 500), xn(e, n));
    do
      try {
        pd();
        break;
...
function Ln(e) {
  ...
  try {
    ...
    (O = r), (xe.transition = t), (R = n), (R & 6) === 0 && vn();
  }
}
function Nu() {
  (me = Wn.current), j(Wn);
...
function wn(e, n, t) {
  var r = O,
    l = xe.transition;
  try {
    (xe.transition = null), (O = 1), md(e, n, t, r);
  } finally {
    (xe.transition = l), (O = r);
  }
  return null;
  ...
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || fe.current) ce = !0;
      ...
      if ((e.lanes & t) === 0 && (n.flags & 128) === 0)
        return (ce = !1), ld(e, n, t);
      ce = (e.flags & 131072) !== 0;
    }
  else (ce = !1), F && (n.flags & 1048576) !== 0 && Js(n, Br, n.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), pe(n, W()), (R & 6) === 0 && ((rt = W() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
vs = _u;
hs = Ln;
var Cd = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, ps, ms, _u] },
  ht = {
  ...
  _d = {
    ...
    findFiberByHostInstance: ht.findFiberByHostInstance || Ed,
...
const Nd = "./assets/react-35ef61ed.svg";
function Pd() {
  const [e, n] = Yt.exports.useState(0);
  return le.exports.jsxs("div", {
    className: "App",
    children: [
      le.exports.jsxs("div", {
        children: [
      ...
      le.exports.jsx("h1", { children: "Vite + React" }),
      le.exports.jsxs("div", {
        className: "card",
        children: [
          le.exports.jsxs("button", {
            onClick: () => n((t) => t + 1),
            children: ["count is ", e],
          }),
          le.exports.jsxs("p", {
            children: [
              "Edit ",
              le.exports.jsx("code", { children: "src/App.jsx" }),
...
Ql.createRoot(document.getElementById("root")).render(
  le.exports.jsx(hc.StrictMode, { children: le.exports.jsx(Pd, {}) })
);
